...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        model= Product
        fields = ['title', 'slug','category','image','marked_price', 'selling_price','description','waranty','return_policy']
        widgets = {
            ...
            'selling_price': forms.NumberInput(attrs={
                'class':'form-control',
                'placeholder':'Selling Priceof the product'
            }),
            ...
            'waranty':forms.TextInput(attrs={
                'class':'form-control',
                'placeholder':'Warranty details of the product..'
            }),
            'return_policy':forms.TextInput(attrs={
                'class':'form-control',
                'placeholder':'return policy ofthe product'
            })
        }
...
class PasswordForgotForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if Customer.objects.filter(user__email=e).exists():
            ...
            raise forms.ValidationError('Email id does not exists..')
        return e
